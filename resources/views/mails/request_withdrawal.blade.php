<head>
    ...
    @else
    <p style="font-size: 16px"><b>Your withdrawal request with Transaction_id {{$transaction_id}} was successful, expect your money into your bank account any time soon </b></p>
    @endif
